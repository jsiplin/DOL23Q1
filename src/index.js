/*
#File: Index.js
#Author: Charles Karpati,Sabelo Mthembu
#Date: March 2020
#Section: Bnia
...
(async()=>{
    ...
    if (!location_search) {
        ...
        <div class="Title">
			<p>Welcome to the Maryland Area Explorer! (Last Updated DOL4 INPROGRESS)</p>
        </div>
        <div class="Body">
		  ...
		  <div id='dropdownMenu' style="display:inline; float:right">
			...
			<p style="display:inline;">Select Time Period:</p>
				<select id='dropdownMenuY' style="display:inline; float:right">
				  ...
				  <option value='data20' selected="selected">2020</option>
				  <option value='data21'>2021</option>
				</select>
