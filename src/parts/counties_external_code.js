...
(async()=>{
    ...
    let fullQuarters =  ["2015Q1", "2015Q2", "2015Q3", "2015Q4", "2016Q1", "2016Q2", "2016Q3", "2016Q4", "2017Q1", "2017Q2", "2017Q3", "2017Q4", "2018Q1", "2018Q2", "2018Q3", "2018Q4", "2019Q1", "2019Q2", "2019Q3", "2019Q4","2020Q1","2020Q2","2020Q3","2020Q4","2021Q1"]
    ...
    configCharts(
      [
        ...
        ['empl_edu_chart', empl_edu_gend_svg, EduAttainment2019], 
        ['empl_edu_gend_chart', empl_edu_gend_svg, unempByGender2019], 
        ['pempl_edu_chart', empl_edu_gend_chart_print, EduAttainment2019], 
        ['pempl_edu_gend_chart', empl_edu_gend_chart_print, unempByGender2019], 
        ['empl_race_ethn_chart', empl_race_ethn_svg, raceData2019], 
        ['chart5', empl_race_ethn_svg, ethData2019], 
        ['pchart5', empl_race_ethn_chart_print, ethData2019], 
        ['pempl_race_ethn_chart', empl_race_ethn_chart_print, raceData2019], 
        ['empl_vet_chart', empl_vet_svg, vetData2019], 
        ['empl_vet_print_chart', empl_vet_print_svg, vetData2019], 
        ...
        ['tanf_attainment_chart', tanf_svg, tanfAttainment2019], 
        ['ptanf_attainment_chart', tanf_chart_print, tanfAttainment2019], 
        ['tanf_data', tanf_svg, tanfData2019], 
        ['ptanf_data', tanf_chart_print,tanfData2019], 
        ['tanf_rate_chart', tanf_svg, tanfRate2019], 
        ['ptanf_rate_chart', tanf_chart_print, tanfRate2019], 
        ['tanf_perc_chart', tanf_svg, tanfPerc2019], 
        ['ptanf_perc_chart', tanf_chart_print, tanfPerc2019], 
        ['pempl_status_chart', disabl_pov_chart_print, povRate2019],  
        ['empl_status_chart', disabl_pov_svg, povRate2019], 
...
/*     {
    ...
    window.countyChartChange = () => {
        ...
        if (lbl == 'Temporary Aid for Needy Families (TANF) Stats') {
            let selectYear = drpY.replace('data', '20')
            display_tanf_table( drpY.replace('data', '20'), window['tanfAttainment'+selectYear],  window['tanfPerc'+selectYear], 
                                window['tanfRate'+selectYear], window['tanfData'+selectYear]) 
